    ...
    >
      <FlexContainer align="start" fullWidthChild>
        <motion.div
          ...
          whileInView="visible"
        >
          <Heading as="h4" size="h4" top="0.9rem">
            Hello!
          </Heading>
          <Heading as="h2" size="h2" top="0.9rem" bottom="1rem">
            I'm <BlueText> WALID KABBOUSSA</BlueText>
          </Heading>
          <Heading as="h3" size="h3">
            I'm a <BlueText> SOFTWARE ENGINEER </BlueText>
          </Heading>
          <ParaText as="p" top="2rem" bottom="4rem">
Hey, I'm Walid Kabboussa, a Software Engineer dedicated to crafting user-friendly Web Applications. Let's build something awesome!
          </ParaText>
